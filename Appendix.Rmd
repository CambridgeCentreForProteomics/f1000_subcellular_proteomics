...
We advise users to load all packages used in the main workflow. Some additional
packages are also required for certain sections of this Appendix, such as the `readxl`
package.
